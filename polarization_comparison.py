...
if make_all_points:
    ...
    intensity_factor_air_vertical = polarizer_transmission_vertical * sensitivity / (photodiode_solid_angle * flux_i)
    intensity_factor_air_horizontal = polarizer_transmission_vertical * sensitivity / (photodiode_solid_angle * flux_i)
    ...
    if horizontal:
        ...
        data_45_horizontal_air = make_data_by_run("horizontal_7_18/75, 60, 45, and 30 in air.txt", -90, 90, intensity_factor_air_horizontal)[1]
    ...
    if vertical:
        ...
        data_45_vertical_air = make_data_by_run("vertical_7_18/75, 60, 45, and 30 in air.txt", -90, 90, intensity_factor_air_vertical)[1]
